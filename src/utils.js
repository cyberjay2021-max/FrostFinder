...
export const OFFICE_EXTS = ['doc','docx','xls','xlsx','pptx','ppt','odt','odp','ods','odg'];  // Office formats — text/PDF extracted in Rust
...
export function driveColor(d){
  return{
    usb:    '#34d399', // green
    mtp:    '#34d399', // green (same as USB — MTP is always USB-connected)
    network:'#60a5fa', // blue
    optical:'#f472b6', // pink
    nvme:   '#a78bfa', // purple
    ssd:    '#60a5fa', // blue
